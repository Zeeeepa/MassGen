...
🛠️Work with files, apps, and projects — MCP tools and agent skills for file read/write (with worktree isolation), background tool execution, web browsing, computer use, and project editing — all with a robust permission system. Use MassGen as a skill from other AI coding agents. Standalone MCP servers (quality, workflow, media) power the massgen-refinery Claude Code plugin. 👉 More Info: https://docs.massgen.ai/en/latest/user_guide/tools/index.html
...
🛠️Work with files, apps, and projects — MCP tools and agent skills for file read/write (with worktree isolation), background tool execution, web browsing, computer use, and project editing — all with a robust permission system. Use MassGen as a skill from other AI coding agents. Standalone MCP servers (quality, workflow, media) power the massgen-refinery Claude Code plugin. 👉 More Info: https://lnkd.in/gXaCJfkq
