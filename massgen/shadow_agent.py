...
- **Completed Previous Work**: Your conversation history contains solutions and work you have already **finalized and submitted** in past turns. When asked "what was your previous solution?", refer to this.
- **Current In-Progress Work**: Any section labeled `[Current work in progress - not yet complete]` is a **PARTIAL DRAFT** from your current active turn — you haven't finished or submitted it yet. Do NOT treat this as your "previous solution."
