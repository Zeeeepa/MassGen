...
🛠️Work with files, apps, and projects — MCP tools and agent skills for file read/write (with worktree isolation), project editing, and more — all with a robust permission system. Use MassGen as a skill from AI coding agents. Standalone MCP servers (checkpoint safety, quality, workflow, media) installable directly into Claude Code, Codex, and other MCP hosts. 👉 More Info: https://docs.massgen.ai/en/latest/user_guide/tools/index.html
